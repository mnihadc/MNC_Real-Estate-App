  ...
  return (
    <div className='p-3 max-w-lg mx-auto'>
      ...
      <form onSubmit={handleSubmit} className='flex flex-col gap-4'>
        ...
        <input defaultValue={currentUser.email} type="email" placeholder='email' id='email' onChange={handleChange} className='border p-3 rounded-lg' />
      ...
      <p className='green-red-700 mt-5'>{updateSuccess ? 'User is updated successfuly' : ''}</p>
    </div>
  )
}
